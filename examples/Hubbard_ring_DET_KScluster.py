...
#    plt.savefig("./figures/density_U{:.3f}_ring_{}_DET_KScluster.pdf".format(U_list[i],opt_method), format="pdf", bbox_inches="tight")
#    plt.show()
#
...
#plt.xticks(fontsize=17)
#plt.yticks(fontsize=17)
#plt.savefig("./figures/Hubbard_ring_energy_{}_DET_KScluster.pdf".format(opt_method), format="pdf", bbox_inches="tight")
#plt.show()
