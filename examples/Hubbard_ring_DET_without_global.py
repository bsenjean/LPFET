...
#    plt.savefig("./figures/density_U{:.3f}_ring_{}_{}_DET_without_global.pdf".format(U_list[i],opt_method,init), format="pdf", bbox_inches="tight")
#    plt.show()
#
...
#plt.xticks(fontsize=17)
#plt.yticks(fontsize=17)
#plt.savefig("./figures/Hubbard_ring_energy_{}_{}_DET_without_global.pdf".format(opt_method,init), format="pdf", bbox_inches="tight")
#plt.show()
