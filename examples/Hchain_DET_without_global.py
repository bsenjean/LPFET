...
#    plt.savefig("./figures/density_R{:.3f}_{}_DET_without_global.pdf".format(Distance[i],opt_method), format="pdf", bbox_inches="tight")
#    plt.show()
#
...
#plt.xticks(fontsize=17)
#plt.yticks(fontsize=17)
#plt.savefig("./figures/Hchain_energy_{}_DET_without_global.pdf".format(opt_method), format="pdf", bbox_inches="tight")
#plt.show()
#
