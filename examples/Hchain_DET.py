...
def norm_density(params):
    ...
    for impurity_index in range(N_mo):
        ...
        h_Ht, g_Ht = tools.transform_1_2_body_tensors_in_new_basis( h_permuted, g_permuted, C_ht )
...
#    plt.savefig("./figures/density_R{:.3f}_{}_DET.pdf".format(Distance[i],opt_method), format="pdf", bbox_inches="tight")
#    plt.show()
#
...
#plt.xticks(fontsize=17)
#plt.yticks(fontsize=17)
#plt.savefig("./figures/Hchain_energy_{}_DET.pdf".format(opt_method), format="pdf", bbox_inches="tight")
#plt.show()
#
